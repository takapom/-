...
- **[animal-excel-import](./animal-excel-import/SKILL.md)** — Run, diagnose, and adjust the developer-only animal Excel import flow with dry-run reports and atomic apply gates.
